...
ROOT_DIR = "E:/Computer Vision/mrcnn2"
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        # Add classes. We have only one class to add.
        self.add_class("object", 1, "straight")
        self.add_class("object", 2, "zebracross")
        ...
        if subset == "train":
            annotations1 = json.load(open('E:/Computer Vision/mrcnn2/dataset/train/train.json'))
        elif subset == "val":
            annotations1 = json.load(open('E:/Computer Vision/mrcnn2/dataset/val/val.json'))

        # annotations1 = json.load(open('E:/Computer Vision/Mask-RCNN/dataset/train/train.json'))
        # print(annotations1)
        ...
        for a in annotations:
            ...
            objects = [s['region_attributes']['names'] for s in a['regions']] #don't forget replace name with names 
            print("objects:",objects)
            # name_dict = {"bottle": 1,"glass": 2,"paper": 3,"trash": 4}
            name_dict = {"straight": 1,"zebracross": 2}
...
def train(model):
    ...
    dataset_train.load_custom("E:/Computer Vision/mrcnn2/dataset", "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("E:/Computer Vision/mrcnn2/dataset", "val")
    dataset_val.prepare()
    ...
    #Set Augmentation Data before training            
    model.train(dataset_train, dataset_val,
                learning_rate=config.LEARNING_RATE,
                epochs=50,
